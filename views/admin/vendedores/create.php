...
<form action="" id="formulario-crear" autocomplete="off">
    <div class="modal-body">
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="hidden" value="<?php echo ($modo == 'A' ?  $lista['idven'] : '') ?>">
                <input type="text" name="txtNombre" id="txtNombre" class="form-control txtnombre" onkeyup="mayusculas(this)" value="<?php echo ($modo == 'A' ?  $lista['nomv'] : '') ?>">
            </div>
        </div>
