...
<form action="" id="formulario-crear" autocomplete="off">
    <div class="modal-body">
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <div class="input-group-append">
                    <input type="text" name="txtRUC" id="txtRUC" onblur="buscaruc()" class="form-control txtruc" onkeyup="mayusculas(this)" onkeypress="return validarNumeros(event);" maxlength="11" value="<?php echo ($modo == 'A' ?  $lista['nruc'] : '') ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <div class="input-group-append">
                    <input type="text" name="txtDNI" id="txtDNI" onblur="buscadni()" class="form-control txtdni" onkeyup="mayusculas(this)" onkeypress="return validarNumeros(event);" maxlength="8" value="<?php echo ($modo == 'A' ?  $lista['ndni'] : '') ?>">
